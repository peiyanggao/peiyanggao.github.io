...
**Links**: [Journal page](https://onlinelibrary.wiley.com/doi/10.1111/jnc.15988) | [PubMed](https://pubmed.ncbi.nlm.nih.gov/37830502/)

This study leveraged the UK Biobank cohort (N = 431,699) to investigate the longitudinal and cross-sectional associations of liver function and liver diseases with incident dementia, cognitive performance, and brain structure.

**Key findings:**

- Decreased ALT (HR = 0.92) and increased AST (HR = 1.05), AST/ALT ratio (HR = 1.20), and GGT (HR = 1.07) were significantly associated with a higher risk of incident all-cause dementia.
- Alcoholic liver disease (HR = 2.87) and fibrosis/cirrhosis of the liver (HR = 2.29) were strongly linked to increased dementia risk.
